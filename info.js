...
client.on("message", msg =>{
    if(msg.content(`${prefix}ruta1`)){
        ...
        .setThumbnail('https://cdn.discordapp.com/attachments/755973908456538146/766351219886522388/articles-150235_logo.png')
        .addField(
            {name: "El link de la plataforma de CPE", value: "https://cpe.ciadti.co/ | Se puede descargar la aplicación Moodle para iniciar sesión desde el teléfono."},
            {name: "Canal de Youtube", value: "https://www.youtube.com/channel/UC46LKHvCp3teYn6OrykTLCg"},
            {name: "Discord - Industrias Creativas", value: "https://discord.gg/86rUf3cBbN"}
        )
        .setTimestamp()
        .setFooter('©MinTic | 2020 | Esteban - Juanjo', 'https://cdn.discordapp.com/attachments/755973908456538146/766365052541468672/misiontic.png')
        msg.delete();
